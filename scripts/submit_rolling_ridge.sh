...
prepare_job="$(sbatch --parsable --job-name=rolling_prepare "--export=ALL,TIME_LAUNCH_ID=${workflow_id}_prepare,ADAPTIME_METHOD=vanilla,ADAPTIME_STAGE=prepare" "$front")"
