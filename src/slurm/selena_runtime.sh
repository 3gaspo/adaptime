...
OUTPUTS_ROOT="${OUTPUTS_ROOT:-${TIME_OUTPUTS:-$TIME_SCRATCH_ROOT/outputs_selena}}"
LOGS_ROOT="${LOGS_ROOT:-${TIME_LOGS:-$TIME_SCRATCH_ROOT/logs_selena}}"
TIME_OUTPUTS="$OUTPUTS_ROOT"
TIME_LOGS="$LOGS_ROOT"

export SELENA_NNI TIME_STORAGE_ROOT TIME_SCRATCH_ROOT
export TIME_DATA_ROOT TIME_DATASET TIME_WEIGHTS
