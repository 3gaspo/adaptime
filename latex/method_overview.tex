...
The unified official-test report compares vanilla $V$, hard retrieval-context
$C$, Bayesian $B$, frozen full Ridge $V'$, and the independently implemented
TS-RAG control. Nested-Ridge variants and the validation-selected family output
are retained as diagnostics, while Seasonal Naive supplies the task scaling
baseline. Each method receives its own standard TIME evaluation artifact on
