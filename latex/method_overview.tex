...
If the complete adaptation-window plan, requested foundation context, or this
minimum datastore cannot be supplied, no ridge is fitted: the task evaluates
TIME's unchanged official test windows with vanilla forecasts and records the
vanilla-only fallback reason.
...
An insufficient-history task is the limiting case with zero eligible Adaptime
windows and vanilla predictions for every learned-method branch.
