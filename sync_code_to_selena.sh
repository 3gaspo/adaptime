...
ssh "$SELENA_HOST" \
    "mkdir -p '$SCRATCH_STORAGE_ROOT/datasets' '$SCRATCH_STORAGE_ROOT/weights' '$SCRATCH_STORAGE_ROOT/venvs' '$SCRATCH_PROJECT_ROOT/outputs_selena' '$SCRATCH_PROJECT_ROOT/logs_selena'"
...
echo "Selena results: $SCRATCH_PROJECT_ROOT/outputs_selena"
